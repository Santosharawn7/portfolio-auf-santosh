  ...
  return (
    <>
      {experienceData.map((experience, index) => {
        const experienceDetail = experienceDescription[index];

        return (
          <div className="w-full p-3" key={index}>
            <div className="p-6 bg-gray-900 border text-left border-gray-800 rounded-3xl">
              <div className="flex flex-wrap items-center -m-4">
                <div className="w-full md:w-1/2 p-4">
                  <h2 className="text-2xl md:font-heading mb-2 md:text-3xl text-white font-black tracking-tight">
                    {experience.title}
                  </h2>
                  <div className="flex flex-wrap -m-3">
                    ...
                    <div className="flex flex-wrap items-center w-auto p-3">
                      ...
                      >
                        <path
                          d="M10 0C4.477 0 0 4.477 0 10s4.477 10 10 10 10-4.477 10-10S15.523 0 10 0zm0 18.182c-4.49 0-8.182-3.692-8.182-8.182S5.51 1.818 10 1.818 18.182 5.51 18.182 10 14.49 18.182 10 18.182zm-.818-12.727h1.636V10H9.091V8.455zm.818 10.909c-.818 0-1.636-.364-2.182-1.091l1.636-1.636c.364.364.818.818 1.273 1.091.455.273 1.091.818 1.818.818.818 0 1.636-.364 2.182-1.091l-1.636-1.636C11.818 13.636 11.091 14 10 14z"
                          fill="#374151"
                          strokeWidth="1.5"
                        />
                      </svg>
                  ...
                  <div className="flex flex-wrap md:justify-end -m-2">
                    <div className="w-full md:w-auto p-2">
                      <button
                        ...
                        className="block w-full px-8 py-3.5 text-lg text-center text-white font-bold bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:ring-gray-600 rounded-full transition-all duration-200 hover:shadow-lg"
                      >
              ...
              {isOpen && selectedExperience === index && (
                <div className="mt-4 bg-gray-700 p-6 rounded-lg shadow-lg border border-gray-700">
                  <h3 className="text-white font-bold text-sm md:text-xl mb-2">Description:</h3>
