            ...
            <div className="container px-4 mx-auto">
                ...
                {education.map((edu) => (
                    ...
                    >
                        ...
                        <div className="w-full bg-gray-700 rounded-lg lg:w-1/2 p-6">
                            <div className="max-w-md lg:max-w-xl mx-auto">
                                <div className="mb-12">
                                    <h1 className="text-xl md:text-4xl xl:text-5xl text-rhino-700 font-bold mb-3 leading-none">
                                        {edu.institution}
                                    </h1>
                                    ...
                                    {edu.programs.map((program, index) => (
                                        <div key={index} className="mb-6">
                                            <h2 className="text-xl text-rhino-700 font-semibold mb-1">
                                                {program.title}
                                            </h2>
                                            ...
                                            {program.gpa && (
                                                <p className="text-sm md:text-lg">{program.gpa}</p>
                                            )}
                                        </div>
                                    ))}
                                </div>
